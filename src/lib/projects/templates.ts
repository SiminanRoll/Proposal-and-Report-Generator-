...
export const PROJECT_TEMPLATES: Record<ProjectType, ProjectTemplate> = {
  "client-report": {
    ...
    description: "Combine security, lifecycle, and technology-health sources into one polished client conversation.",
    outcome: "Interactive review + client takeaway report",
    accent: "teal",
    ...
    sources: [
      { kind: "scalepad-pdf", label: "ScalePad report", description: "Device lifecycle, warranty, and infrastructure health", required: true, extensions: [".pdf"] },
  ...
  "prospect-proposal": {
    ...
    description: "Turn onsite discovery into a complete assessment, recommendation, and low-friction proposal.",
    ...
    sources: [
      { kind: "rft-spreadsheet", label: "RFT spreadsheet", description: "Technical environment and assessment findings", required: true, extensions: [".xlsx", ".xls"] },
  ...
  "legacy-modernization": {
    ...
    description: "Extract an existing quote and move it into the new interactive Advantage proposal experience.",
    outcome: "Modern interactive proposal with confirmed pricing",
    accent: "violet",
    ...
    sources: [
      { kind: "legacy-proposal", label: "Existing proposal", description: "Current or legacy quote to convert", required: true, extensions: [".pdf", ".docx"] },
