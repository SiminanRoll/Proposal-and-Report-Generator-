...
export const HIPAA_QUESTIONS: HipaaQuestionDefinition[] = [
  ...
  },
  {
    ...
    plainLanguageExplanation: "A current assessment and a clear plan for open risks are what matter here. You do not need to attach the assessment.",
  ...
  },
  {
    ...
    plainLanguageExplanation: "Answer based on the practice’s normal vendor process. You do not need to attach a vendor list or copies of agreements.",
