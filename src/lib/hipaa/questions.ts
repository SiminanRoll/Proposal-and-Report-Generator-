...
export const HIPAA_QUESTIONS: HipaaQuestionDefinition[] = [
  ...
  },
  {
    ...
    plainLanguageExplanation: "Advantage proposes what can be confirmed from managed backup information. An identified Cloud Plus backup server supports this control, but its presence alone does not verify current backup health or recovery testing.",
