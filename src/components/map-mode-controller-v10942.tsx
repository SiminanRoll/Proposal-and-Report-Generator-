...
const NATIVE_MODES: Array<Exclude<MapLensDisplayMode, "segments">> = ["clients", "need", "value"];
...
export function MapModeControllerV10942() {
    ...
    const bindTarget = () => {
      ...
      const buttonCleanups = buttons.map((button, index) => {
        const onClick = () => {
          ...
          const nextMode = NATIVE_MODES[index];
          if (nextMode === "clients") {
