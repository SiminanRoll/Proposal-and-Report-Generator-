...
export function TerritoryCompassHub({ bearing = 0, active = true, title = "Client Compass direction" }: TerritoryCompassHubProps) {
  return <g className={`territory-compass-hub${active ? " is-active" : " is-idle"}`} aria-hidden="true">
    ...
    <g className="territory-compass-needle" style={{ "--compass-bearing": `${bearing}deg` } as CSSProperties}>
