  ...
  return <div className="compass-admin-page compass-settings-page">
    ...
    <section className="compass-settings-section">
      ...
      <div className="compass-settings-grid two-column">
        <label className="compass-settings-field"><span>Default dashboard view</span><select value={draft.coverage.defaultCardSet} onChange={(event) => updateCoverage({ defaultCardSet: event.target.value as CompassConfig["coverage"]["defaultCardSet"] })}><option value="client-project-coverage">Client Project Coverage</option>{draft.coverage.priorityLensEnabled && <option value="priority-lens">Priority Lens</option>}</select><small>The view shown when Client Compass opens or settings are refreshed.</small></label>
