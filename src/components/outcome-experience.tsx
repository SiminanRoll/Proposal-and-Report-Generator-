...
function RecapPresentation({ project, onUpdate }: { project: Project; onUpdate: (project: Project) => void }) {
  ...
  const canSchedulePlanning = !noActionNeeded && healthPriorities > 0 && !agreedPlan && approach.mode !== "purchase-planning";
