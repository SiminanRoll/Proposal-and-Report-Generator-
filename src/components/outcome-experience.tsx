...
function LifecyclePresentation({ project }: { project: Project }) {
  ...
  return (
    <div className={`presentation-section-layout message-${message.tone}`}>
      <div className="presentation-section-heading network-health-heading"><span className="presentation-kicker">Network health & equipment age</span><h2>{message.title}</h2><p>{message.subtitle}</p></div>
