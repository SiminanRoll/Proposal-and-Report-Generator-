...
test("technical prefills stay limited to observable monitoring and backup checkpoints", () => {
  for (const key of ["huntress.entitiesProtected", "huntress.eventsAnalyzed", "huntress.signalsDetected", "backup.endpointMissing"]) assert.match(engine, new RegExp(key.replaceAll(".", "\\.")));
