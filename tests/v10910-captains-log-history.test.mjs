...
test("Client Compass 1.0.9.26 keeps the complete matched Captain's Log history", () => {
  assert.equal(pkg.version, "1.0.9.26");
...
test("client history is history plus simple refresh and add actions", () => {
...
test("coordination tasks do not use open-work gates", () => {
...
test("Captain's Log compasses are history indicators instead of task gates", () => {
