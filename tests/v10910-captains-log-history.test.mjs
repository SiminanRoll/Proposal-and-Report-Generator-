...
test("Client Compass 1.0.9.10 keeps the complete matched Captain's Log history", () => {
  assert.equal(pkg.version, "1.0.9.10");
...
test("1.0.9.10 bulk sync refreshes the entire client book in one pass", () => {
...
test("1.0.9.10 turns the client history area into history plus simple refresh and add actions", () => {
...
test("1.0.9.10 creates coordination tasks without open-work gates", () => {
...
test("1.0.9.10 uses Captain's Log compasses as history indicators instead of task gates", () => {
