...
test("v1.0.9.25 ships the current Client Compass PNG and ICO browser assets", () => {
  ...
  assert.match(version, /1\.0\.9\.25/);
  assert.match(layout, /client-compass-icon\.png\?v=10925/);
  assert.match(layout, /client-compass\.ico\?v=10925/);
