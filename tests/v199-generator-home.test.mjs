...
test("v1.0.9.10 replaces the legacy generator hero with a compact landing header", () => {
...
test("v1.0.9.10 uses current report and proposal language in the recent list", () => {
...
test("v1.0.9.10 moves report and proposal backup controls into Settings", () => {
...
test("v1.0.9.10 keeps the generator dense on desktop", () => {
