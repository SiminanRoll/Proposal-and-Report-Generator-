...
test("v1.0.9.15 replaces the legacy generator hero with a compact landing header", () => {
...
test("v1.0.9.15 uses current report and proposal language in the recent list", () => {
...
test("v1.0.9.15 moves report and proposal backup controls into Settings", () => {
...
test("v1.0.9.15 keeps the generator dense on desktop", () => {
