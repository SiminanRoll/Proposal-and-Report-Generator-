...
test("v1.0.9.13 replaces the legacy generator hero with a compact landing header", () => {
...
test("v1.0.9.13 uses current report and proposal language in the recent list", () => {
...
test("v1.0.9.13 moves report and proposal backup controls into Settings", () => {
...
test("v1.0.9.13 keeps the generator dense on desktop", () => {
