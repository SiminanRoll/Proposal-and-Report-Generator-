...
test("shared task contract remains available while retiring the protocol handoff", async () => {
...
test("v1.0.9.41 keeps shared Supabase task support out of the streamlined client UI", () => {
